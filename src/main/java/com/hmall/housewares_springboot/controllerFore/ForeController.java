package com.hmall.housewares_springboot.controllerFore;
import com.hmall.housewares_springboot.comparator.*;
import com.hmall.housewares_springboot.pojo.*;
import com.hmall.housewares_springboot.service.*;
...
//          subject.getSession().setAttribute("user", user);
    ...
    public Object category(@PathVariable int cid,String sort) {
        ...
        if(null!=sort){
            switch(sort){
                case "review":
                    Collections.sort(c.getProducts(),new ReviewComparator());
                    break;
                case "date" :
